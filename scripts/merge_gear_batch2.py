#!/usr/bin/env python3
"""Merge gear_batch2_items.json into ../data/gear.json.
Same logic as merge_gear_batch.py but reads from gear_batch2_items.json.
"""
import json
...
BATCH_PATH = Path(__file__).resolve().parent / "gear_batch2_items.json"
